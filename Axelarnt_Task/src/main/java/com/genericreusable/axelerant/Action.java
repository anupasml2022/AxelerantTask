...
public class Action extends BaseClass{
	...
	public void scrollByVisibilityOfElement(WebDriver driver, WebElement enterUsername) {
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].scrollIntoView();", enterUsername);
	...
	public boolean moveToElement(WebDriver driver, WebElement ele) {
		...
		try {
		    ...
		    //Sactions.moveToElement(driver.findElement(locator)).build().perform();
